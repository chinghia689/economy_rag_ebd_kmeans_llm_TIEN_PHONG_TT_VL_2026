...
Cách dùng:
    ...
    python GT3_Auto/create_eval.py --output GT3_results.xlsx
    python GT3_Auto/create_eval.py --start 991   # tiếp tục từ câu 991
"""

from __future__ import annotations

# Bootstrap: hỗ trợ cả `python -m` và `python GT3_Auto/create_eval.py`
if __name__ == "__main__" and __package__ is None:
    import sys
    from pathlib import Path
    sys.path.insert(0, str(Path(__file__).resolve().parent.parent))
    __package__ = "GT3_Auto"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="GT3: LLM Auto Split → Multi-Vector ERC")
    parser.add_argument("--input", default=str(PROJECT_ROOT / "scoring" / "file 1000 cau hoi.xlsx"))
    parser.add_argument("--output", default=str(HERE / "GT3_eval_results.xlsx"))
    ...
    run_eval(
        ...
        llm=llm,
        algorithm="GT3_llm_auto_split_erc",
