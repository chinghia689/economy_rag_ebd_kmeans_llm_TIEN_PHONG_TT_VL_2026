...
Cách dùng:
    ...
    python GT1_LLM_Auto/create_eval.py --output GT1_results.xlsx
    python GT1_LLM_Auto/create_eval.py --start 991   # tiếp tục từ câu 991
"""

from __future__ import annotations

# Bootstrap: hỗ trợ cả `python -m` và `python GT1_LLM_Auto/create_eval.py`
if __name__ == "__main__" and __package__ is None:
    import sys
    from pathlib import Path
    sys.path.insert(0, str(Path(__file__).resolve().parent.parent))
    __package__ = "GT1_LLM_Auto"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="GT1: LLM Auto Split → Multi-Vector ERC")
    ...
    run_eval(
        ...
        llm=llm,
        algorithm="GT1_llm_auto_split_erc",
