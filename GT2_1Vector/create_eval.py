...
Cách dùng:
    ...
    python GT2_1Vector/create_eval.py --output GT2_results.xlsx
    python GT2_1Vector/create_eval.py --start 991   # tiếp tục từ câu 991
"""

from __future__ import annotations

# Bootstrap: hỗ trợ cả `python -m` và `python GT2_1Vector/create_eval.py`
if __name__ == "__main__" and __package__ is None:
    import sys
    from pathlib import Path
    sys.path.insert(0, str(Path(__file__).resolve().parent.parent))
    __package__ = "GT2_1Vector"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="GT2: Single Vector → ERC")
    parser.add_argument("--input", default=str(PROJECT_ROOT / "scoring" / "file 1000 cau hoi.xlsx"))
    parser.add_argument("--output", default=str(HERE / "GT2_eval_results.xlsx"))
    ...
    run_eval(
        ...
        llm=llm,
        algorithm="GT2_single_vector_erc",
